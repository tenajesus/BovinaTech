...
#Procesar el formulario de salida particular

def procesar_form_particular(dataForm, foto_perfil):
    ...
    try:
        with connectionBD() as conexion_MySQLdb:
            with conexion_MySQLdb.cursor(dictionary=True) as cursor:
                ...
                sql = "INSERT INTO comisiones_particular(fecha_solicitud,medio_solicitud,num_documento,fecha_inicial,fecha_final,descripcion,lugar_comision,importe_asignado,area,comisionado,folio_ticket,foto_empleado) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"

                # Creando una tupla con los valores del INSERT
                valores = (dataForm['fecha_solicitud'], dataForm['medio_solicitud'], dataForm['num_documento'],
                           dataForm['fecha_inicial'], dataForm['fecha_final'], dataForm['descripcion_com'],
                           dataForm['lugar_comision'], dataForm['importe_asignado'], dataForm['area'],
                           dataForm['comisionado'], dataForm['folioticket'], result_foto_perfil)
                cursor.execute(sql, valores)
        ...
        return f'Se produjo un error en procesar_form_particular: {str(e)}'
    
#Procesar formulario vehiculo oficial

def procesar_form_oficial(dataForm, foto_perfil):
    ...
    try:
        with connectionBD() as conexion_MySQLdb:
            with conexion_MySQLdb.cursor(dictionary=True) as cursor:
                ...
                sql = "INSERT INTO comisiones_oficial(fecha_solicitud,medio_solicitud,num_documento,fecha_inicial,fecha_final,comisionado,licencia,area,descripcion,lugar,km_inicial,km_final,total_recorrido,fecha_carga_com,importe,folio_ticket,litros_ticket,rendimiento_promedio,precio_compra_comb,total_consumo,observaciones,num_eco,foto_empleado) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
                
                # Creando una tupla con los valores del INSERT
               
                
                valores = (dataForm['fecha_solicitud'], dataForm['medio_solicitud'], dataForm['num_documento'],dataForm['fecha_inicial'], dataForm['fecha_final'],dataForm['comisionado'],dataForm['licencia'],dataForm['area'],dataForm['descripcion_com'],dataForm['lugar_comision'], dataForm['km_inicial'],dataForm['km_final'],dataForm['total_recorrido'],dataForm['fecha_carga'],dataForm['importe_cargado'],dataForm['folioticket'],dataForm['litros_ticket'],dataForm['rendimiento'],dataForm['precio_compra'],dataForm['total_consumo'],dataForm['observa'],dataForm['num_eco'], result_foto_perfil)
        ...
        return f'Se produjo un error en procesar_form_oficial: {str(e)}'
        ...
        with connectionBD() as conexion_MySQLdb:
            with conexion_MySQLdb.cursor(dictionary=True) as cursor:
                querySQL = (f"""
                    SELECT 
                        *
                    FROM comisiones_particular AS e
                    ORDER BY e.id DESC
                    """)
                cursor.execute(querySQL,)
                particularesBD = cursor.fetchall()
        return particularesBD
    except Exception as e:
        print(
            f"Errro en la función sql_lista_particulares: {e}")
        return None    

#Lista_Solicitudes
#     
def sql_lista_oficiales():
    try:
        with connectionBD() as conexion_MySQLdb:
            with conexion_MySQLdb.cursor(dictionary=True) as cursor:
                querySQL = (f"""
                    SELECT 
                        *
                    FROM comisiones_oficial AS of
                    ORDER BY of.id DESC
                    """)
                cursor.execute(querySQL,)
                oficialesBD = cursor.fetchall()
        return oficialesBD
    except Exception as e:
        print(
            f"Errro en la función sql_lista_oficiales: {e}")
        return None
...
# Detalles de Salidas oficiales
def sql_detalles_salidas(id):
    try:
        with connectionBD() as conexion_MySQLdb:
            with conexion_MySQLdb.cursor(dictionary=True) as cursor:
                querySQL = ("""
        ...
        print(
            f"Errro en la función sql_detalles_salidas: {e}")
        return None

# Detalles de Salidas particulares
def sql_detalles_part(id):
    try:
        with connectionBD() as conexion_MySQLdb:
            with conexion_MySQLdb.cursor(dictionary=True) as cursor:
                querySQL = ("""
...
def buscarOficialBD(search):
    try:
        ...
        print(f"Ocurrió un error en def buscarOficial: {e}")
        return []
    
def buscarParticular(search):
    try:
        with connectionBD() as conexion_MySQLdb:
            with conexion_MySQLdb.cursor(dictionary=True) as mycursor:
                querySQL = ("""
        ...
        print(f"Ocurrió un error en def buscarparticular: {e}")
        return []
